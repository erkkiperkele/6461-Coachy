...
import com.erkkiperkele.coachy.Model.DAL.WorkoutDataAccessLayer;
...
public class WorkoutModel {
    private WorkoutDataAccessLayer _dataAccessLayer;

    public WorkoutModel() {
        _dataAccessLayer = new WorkoutDataAccessLayer();
    }
